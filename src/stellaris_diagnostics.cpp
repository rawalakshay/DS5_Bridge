...
constexpr RumbleCandidate kRumbleCandidates[] = {
    ...
    // Graduated amplitudes from the same encoder the rumble path now uses. If
    // these four feel progressively stronger, the pad decodes amplitude and
    // proportional rumble works. If they all feel identical -- or all silent --
    // it only pattern-matches the frame above, and rumble stays on/off.
    {"10 AMPLITUDE 25 PCT", 10,
     {0x10, 0x02, 0x00, 0x33, 0x40, 0x4C, 0x00, 0x33, 0x40, 0x4C},
     {0x10, 0x03, 0x00, 0x01, 0x40, 0x40, 0x00, 0x01, 0x40, 0x40}},
    {"10 AMPLITUDE 50 PCT", 10,
     {0x10, 0x04, 0x00, 0x65, 0x40, 0x59, 0x00, 0x65, 0x40, 0x59},
     {0x10, 0x05, 0x00, 0x01, 0x40, 0x40, 0x00, 0x01, 0x40, 0x40}},
    {"10 AMPLITUDE 75 PCT", 10,
     {0x10, 0x06, 0x00, 0x97, 0x40, 0x65, 0x00, 0x97, 0x40, 0x65},
     {0x10, 0x07, 0x00, 0x01, 0x40, 0x40, 0x00, 0x01, 0x40, 0x40}},
    {"10 AMPLITUDE 100 PCT", 10,
     {0x10, 0x08, 0x00, 0xC9, 0x40, 0x72, 0x00, 0xC9, 0x40, 0x72},
     {0x10, 0x09, 0x00, 0x01, 0x40, 0x40, 0x00, 0x01, 0x40, 0x40}},
    {"11 DS4-LIKE", 8,
